                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                        ...
                                                        <tbody>
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>c++prims</td>
                                                                <td>50</td>
                                                                <td class="center">170102030117</td>
                                                                <td class="center">170102030113</td>
                                                                <td>0</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><%=rs.getString("sale_sid")%></td>
                                                                <td><%=rs.getString("buy_sid")%></td>
                                                                <td><%=rs.getString("business_res")%></td>
                                                                <td>
                                                                    <a href='business_edit.jsp?id=<%=rs.getString("id")%>'>编辑</a>
                                                                    <a href='business_delete.jsp?id=<%=rs.getString("id")%>'>删除</a>
                                                                </td>
                                                            </tr>
                                                            <%
                                                                }
