<%-- 
    Document   : login
    Created on : 2019-12-17, 21:58:02
    Author     : 82058
--%>
...
<div id="tab">
  ...
  <div class="tab_box"> 
    ...
    <div>
      ...
      <form action="dologin.jsp" method="post" class="stu_login_error">
        <div id="username">
          <label>学&nbsp;&nbsp;&nbsp;号：</label>
   ...
   <!-- 学生登录结束-->
    ...
    <div class="hide">
     <!--<div class="tea_error_box"></div>-->
      <form action="dologin.jsp" method="post" class="tea_login_error">
        <div id="username">
          <label>教工号：</label>
    ...
    <!--<div class="sec_error_box"></div>-->
      <form action="dologin.jsp" method="post" class="sec_login_error">
        <div id="username">
          <label>教务号：</label>
